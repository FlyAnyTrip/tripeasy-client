...
import aboutImg2 from "../assets/about/about-img-2.jpeg";
import AnimatedElement from "../components/AnimatedElement";
import CounterAnimation from "../components/CounterAnimation";
import SEOHead from "../components/SEOHead";
// Add team member images (you'll need to add these to your assets)
import anshumanImg from "../assets/team/anshuman.jpg";
import alisImg from "../assets/team/alis.jpg";
import abhishekImg from "../assets/team/abhishek.jpg";
import parthImg from "../assets/team/parth.jpg";
import vibhuImg from "../assets/team/vibhu.jpg";
import divyaImg from "../assets/team/divya.jpg";
import ayushiImg from "../assets/team/ayushi.jpg";
import swastikImg from "../assets/team/swastik.jpg";
              ...
              <div className="about-team-member">
                <div className="about-team-img">
                  <div className="about-team-img-effects">
                    <img
                      src={anshumanImg || "/placeholder.svg"}
                      alt="Anshuman Singh"
            ...
            <AnimatedElement animation="fade-up" delay={300}>
              <div className="about-team-member">
                <div className="about-team-img">
                  <div className="about-team-img-effects">
                    <img
                      src={abhishekImg || "/placeholder.svg"}
                      alt="Abhishek Jha"
                      className="about-team-image"
                    />
                  </div>
            ...
            <AnimatedElement animation="fade-up" delay={200}>
              <div className="about-team-member">
                <div className="about-team-img">
                  <div className="about-team-img-effects">
                    <img
                      src={swastikImg || "/placeholder.svg"}
                      alt="Swastik Moolya"
                      className="about-team-image"
                    />
                  </div>
